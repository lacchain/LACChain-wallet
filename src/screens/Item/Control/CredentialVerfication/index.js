...
export function Wait({ className }) {
  return (
...
function CredentialVerfication({ className, results, typeToRender }) {
  const steps = typeToRender === 'type1'
...
export function Type1CredentialVerfication({ className, results }) {
  return (
...
export function Type2CredentialVerfication({ className, results }) {
  return (
    <CredentialVerfication
      className={className}
      results={results}
