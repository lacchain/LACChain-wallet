          ...
          <div className={styles.wrapper}>
            ...
            <div className={styles.group}>
              <div className={styles.item}>
                {activeIndex === 0 && (
                  <Items class={styles.items} items={credentials.slice(0, 3)} />
                )}
                {activeIndex === 1 && (
                  <Items class={styles.items} items={credentials.slice(0, 6)} />
                )}
                {activeIndex === 2 && (
                  <Items class={styles.items} items={credentials.slice(0, 2)} />
                )}
                {activeIndex === 3 && (
                  <Items class={styles.items} items={credentials.slice(0, 3)} />
                )}
